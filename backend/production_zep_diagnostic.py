...
def main():
            ...
            for name, breaker in breakers.items():
                if "zep" in name.lower():
                    ...
                    if state == "OPEN":
                        ...
                        print(
                            "   💡 Fix: Reset circuit breaker or wait for recovery timeout"
                        )
        else:
    ...
    try:
        ...
        user = client.user.add(
            ...
            metadata={"user_type": "business_owner", "source": "diagnostic_test"},
        )
...
def generate_fix_recommendations():
    ...
    print(
        "     curl -H 'Authorization: Api-Key YOUR_KEY' https://api.getzep.com/api/v2/users"
    )
    print()
