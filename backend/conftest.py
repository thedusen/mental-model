...
class MockZepMemory:
    ...
    def get_business_profile(self, user_id: str):
        ...
        return {"company_name": "Test Company", "industry": "Technology", "role": "CEO"}

    async def add_message(
        self, user_id: str, session_id: str, message: str, role: str = "user"
    ):
...
def app_with_mocks(mock_zep_memory, mock_supabase_service, mock_neo4j_driver):
    ...
    with patch("main.zep_memory", mock_zep_memory), patch(
        "main.supabase_service", mock_supabase_service
...
def session_request():
    ...
    return {"user_id": "test-user-123", "title": "Test Session"}
