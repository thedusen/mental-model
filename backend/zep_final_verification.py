...
def main():
    ...
    try:
        ...
        try:
            ...
            print(f"📊 Total users: {len(users_response.users) if users_response.users else 0}")
            ...
            if users_response.users:
                ...
                print(f"✅ You should see these {len(users_response.users)} users in your Zep dashboard")
        ...
        try:
            ...
            users_response = client.user.list_ordered()
            print(f"📊 Updated total users: {len(users_response.users) if users_response.users else 0}")
