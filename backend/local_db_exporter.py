...
class LocalDBExporter:
    ...
    def export_constraints_and_indexes(self):
        ...
        with self.driver.session() as session:
            ...
            logger.info(
                f"✅ Exported {len(constraints)} constraints and {len(indexes)} indexes"
            )
    ...
    def get_database_stats(self):
        ...
        with self.driver.session() as session:
            ...
            logger.info(
                f"✅ Database stats: {node_count} nodes, {rel_count} relationships"
            )
            return stats
    ...
    def export_complete_database(self, output_file=None):
        ...
        try:
            ...
            logger.info(
                f"📊 Export summary: {len(nodes)} nodes, {len(relationships)} relationships"
            )
...
def main():
    ...
    if result:
        ...
        print(
            f"   - {result['statistics']['total_relationships']} relationships exported"
        )
